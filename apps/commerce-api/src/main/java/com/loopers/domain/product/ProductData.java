...
public record ProductData(String productName, int amount, int quantity, String brandName, long likeCount) {
    public static ProductData from(Product product, Brand brand, long likeCount) {

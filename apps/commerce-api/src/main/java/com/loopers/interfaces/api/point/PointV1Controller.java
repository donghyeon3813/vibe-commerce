...
public class PointV1Controller implements PointV1ApiSpec {
    ...
    @GetMapping
    @Override
    public ApiResponse<PointV1Dto.PointInfoResponse> getPointInfo(@RequestHeader(value = X_USER_ID) String userId) {
    ...
    @PostMapping("/charge")
    @Override
    public ApiResponse<PointV1Dto.PointChargeResponse> chargePoint(@RequestBody ChargePointRequest request, @RequestHeader(value = X_USER_ID) String userId) {

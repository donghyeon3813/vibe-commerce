...
public class OrderTest {
    ...
    class Create {
        ...
        void throwsBadRequest_WhenOrderItemIsNull() {
            OrderModel orderModel = OrderModel.create(999L, 1000, Address.of("주소", "01000000000", "이름"));
        ...
        void throwsBadRequest_WhenUserIdIsNull() {
            ...
            CoreException exception = assertThrows(CoreException.class,
                    () -> OrderModel.create(null, 1000, Address.of("주소", "01000000000", "이름")));
        ...
        void throwsBadRequest_WhenAmountIsNegative(int amount) {
            ...
            CoreException exception = assertThrows(CoreException.class,
                    () -> OrderModel.create(999L, amount, Address.of("주소", "01000000000", "이름")));
        ...
        void success() {
            ...
            OrderModel orderModel = OrderModel.create(999L, 100, Address.of("주소", "01000000000", "이름"));
            assertThat(orderModel).isNotNull();
            assertThat(orderModel.getUserUid()).isEqualTo(999L);
            assertThat(orderModel.getAmount()).isEqualTo(100);
        }
